 ...
 *
 * This hook makes it easy to see which prop changes are causing a component
 * to re-render. If a function is particularly expensive to run and you know
 * it renders the same results given the same props you can use the React.memo
